...
return [
    ...
    'GET|/contador-insercao' => \Correios\ContadorDePaginas\Controller\ControllerContadorInsercao::class,
    'POST|/contador-insercao' => \Correios\ContadorDePaginas\Controller\ControllerContadorInsercao::class,
    'GET|/matriz-multiplex' => \Correios\ContadorDePaginas\Controller\ControllerMatrizMultiplex::class,
    'GET|/matriz-insercao' => \Correios\ContadorDePaginas\Controller\ControllerMatrizInsercao::class,
